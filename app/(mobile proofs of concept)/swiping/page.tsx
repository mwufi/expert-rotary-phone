...
import { fetchInitialLeetCodeQuestions, feedback } from './server';
...
const LeetCodeSwiper: React.FC = async () => {
    const [questions, setQuestions] = useState<LeetCodeQuestion[]>(await fetchInitialLeetCodeQuestions());
